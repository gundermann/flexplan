...
public class FlextimeTable {
  ...
  public static String createTable() {
    ...
    sb.append( "create table " ).append( TABLE_NAME ).append( " (" ).append( DATE ).append( " text primary key, " )
        .append( TIME_FROM ).append( " numeric, " ).append( TIME_TO ).append( " numeric, " ).append( IS_HOLIDAY )
        .append( " text );" );
    return sb.toString();
  }
  ...
  public static ContentValues getContentValues( FlextimeDay flextimeDay ) {
    ...
    values.put( IS_HOLIDAY, String.valueOf( flextimeDay.isHoliday() ) );
    return values;
  }

  public static String[] selectAll() {
    String[] selection = { DATE, TIME_FROM, TIME_TO, IS_HOLIDAY };
    return selection;
  }
  ...
  public static String[] selectIsHoliday() {
    String[] selection = { IS_HOLIDAY };
    return selection;
  }
}
